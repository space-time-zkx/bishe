...
class DataAugmentor(object):
    ...
    def random_world_flip(self, data_dict=None, config=None):
        ...
        # print(data_dict['points'].shape,"46")
        ...
        # print(data_dict['points'].shape,"56")
        return data_dict
    ...
    def forward(self, data_dict):
        # print(data_dict['points'].shape,data_dict['co_xy'].shape,"103")
        """
        Args:
            data_dict:
                points: (N, 3 + C_in)
        ...
        for cur_augmentor in self.data_augmentor_queue:
            # print(data_dict['points'].shape,data_dict['co_xy'].shape,"115")
            # print(cur_augmentor)
            data_dict = cur_augmentor(data_dict=data_dict)
            # print(data_dict['points'].shape,data_dict['co_xy'].shape,"118")

        data_dict['gt_boxes'][:, 6] = common_utils.limit_period(
            data_dict['gt_boxes'][:, 6], offset=0.5, period=2 * np.pi
        )
        # print(data_dict['points'].shape,"123")
