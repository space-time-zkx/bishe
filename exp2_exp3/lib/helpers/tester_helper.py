    ...
    def test_one_epoch(self):
        ...
        for _, data in enumerate(self.dataloader):
            ...
            if self.cfg['format'] == 'fpointnet':
                input, rot_angle, rgb_prob, id, type, box2d, one_hot_vec,box2d,lcimage = data
            ...
            # model inference
            # , box2d.cuda(), lcimage.cuda()
            outputs = self.model(input.cuda(), one_hot_vec.cuda(), box2d.cuda(), lcimage.cuda())
