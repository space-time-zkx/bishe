...
def main():
    ...
    # checkpoints = "/data/zhaokexin/vision/3d_object/patchnet-master/experiments/patchnet/checkpoints_after_classattn_/checkpoint_epoch_100.pth"
    # model.load_state_dict(torch.load(checkpoints)["model_state"])
    # print(model)
